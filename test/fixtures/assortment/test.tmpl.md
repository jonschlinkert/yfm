...
{% if (changelog) {
  _.each(changelog, function(details, version) {
    ...
    if (date instanceof Date) {
      date = _.date(new Date(date.getTime() + date.getTimezoneOffset() * 60000), 'yyyy-mm-dd');
    }
    print('\n * ' + [
      date,
      version,
...
_This file was generated by [grunt-readme](https://github.com/assemble/grunt-readme) on {%= _.date("full") %}._
